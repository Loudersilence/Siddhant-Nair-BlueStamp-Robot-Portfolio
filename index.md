...
- What your plan is to complete your project: To further improve the robotic arm, I plan on improving the the mobility of the claw by adding another servo that rotates the claw. I also plan on adding a pi camera for color and object detection so the arm can recognize objects around it and hopefully be commanded to pick up specific objects.
# Schematics 
