...
- Getting the Arduino to process the incoming commands. When the Pi first sent the commands, I wasn't sure if the Arduino was receiving the commands, but after looking at the serial monitor after some and the blinking rx light on the Nano, I was able to verify that the Arduino was receiving the commands.<br/>
  <img src="images/Serial monitor.png" alt=" Serial monitor" width="660" length="300" /> <br/>
...
<img src="images/broken base piece.jpg" alt=" Broken Base Piece " width="500" length="300" />
